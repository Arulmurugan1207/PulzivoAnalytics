  ...
  useCases = [
    {
      ...
      description: 'Automatically track every page view with zero configuration. Higher plans add sessions, bounce rate, and drop-off paths.',
      highlights: ['Page views', 'Click tracking', 'Custom events', 'One script tag'],
    ...
    },
    {
      ...
      highlights: ['localStorage flag', 'URL query param', 'SDK setOwner()', 'Accurate data only'],
